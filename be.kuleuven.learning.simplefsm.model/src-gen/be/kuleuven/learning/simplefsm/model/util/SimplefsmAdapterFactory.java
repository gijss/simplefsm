/**
 */
package be.kuleuven.learning.simplefsm.util;

import be.kuleuven.learning.simplefsm.*;
 ...
 * @generated
 */
public class SimplefsmAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static SimplefsmPackage modelPackage;
   ...
   * @generated
   */
  public SimplefsmAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = SimplefsmPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected SimplefsmSwitch<Adapter> modelSwitch =
  ...
  /**
   * Creates a new adapter for an object of class '{@link be.kuleuven.learning.simplefsm.State <em>State</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link be.kuleuven.learning.simplefsm.Transition <em>Transition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
